...
class Category(models.Model):
  ...
  image = CloudinaryField('image', folder="image/shop/categories/", null=True, blank=True)
...
class Product(models.Model):
  ...
  image = CloudinaryField('image', folder="image/shop/products/",null=True, blank=True)
